 ...
 *
 * @package WordPress
 * @subpackage bootville 1.0
 */


if ( !function_exists( 'bspwp_custom_css' ) ) {
	
	add_action('wp_head', 'bvwp_custom_css');
	function bvwp_custom_css() {
			
			$custom_css ='';

			if(bvwp_option('custom_css') != '') {
				$custom_css .= bvwp_option('custom_css');
			}	

			if(bvwp_option('disable_fixed_navbar') == '1') {
