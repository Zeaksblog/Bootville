 ...
 * @return array
 */
function bootville_page_menu_args( $args ) {
	$args['show_home'] = true;
	return $args;
}
add_filter( 'wp_page_menu_args', 'bootville_page_menu_args' );
 ...
 * @return array
 */
function bootville_body_classes( $classes ) {
 ...
 * @return void
 */
function bootville_setup_author() {
	global $wp_query;
